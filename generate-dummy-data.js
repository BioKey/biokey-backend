...
confirm("This will delete all current data, do you want to proceed?", function() {
    ...
    .then(db => {
        ...
        let users = [{email:"a@a.com",name:"A",password:"a",isAdmin:true,organization:"A"},{email:"b@b.com",name:"B",password:"b",isAdmin:false,organization:"A"},{email:"c@c.com",name:"C",password:"c",isAdmin:false,organization:"A"},{email:"d@d.com",name:"D",password:"d",isAdmin:false,organization:"B"}]    
        let typingProfiles = [{user:"A",machine:"ABC",authStatus:false,lockStatus:false,accessToken:"tokenA",tensorFlowModel:"modelA"},{user:"B",machine:"DEF",authStatus:false,lockStatus:false,accessToken:"tokenB",tensorFlowModel:"modelB"},{user:"C",machine:"GHI",authStatus:false,lockStatus:false,accessToken:"tokenC",tensorFlowModel:"modelC"},{user:"D",machine:"JKL",authStatus:false,lockStatus:false,accessToken:"tokenD",tensorFlowModel:"modelD"}]
